<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      <div class="pic-404">
        <img class="pic-404__parent" :src="src" alt="404">
        <img class="pic-404__child left" :src="src1" alt="404">
        <img class="pic-404__child mid" :src="src1" alt="404">
        <img class="pic-404__child right" :src="src1" alt="404">
      </div>
      <div class="bullshit">
...
export default {
  ...
  data() {
    return {
      ...
      src1: require('@/assets/404_images/404_cloud.png')
    }
  },
  computed: {
    message() {
